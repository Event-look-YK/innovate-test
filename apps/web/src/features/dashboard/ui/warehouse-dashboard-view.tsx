...
const kpis = [
  { label: "Pending pickups", value: 6, icon: "📦", color: "bg-amber-50 text-amber-600" },
  { label: "Loading now", value: 2, icon: "🔄", color: "bg-sky-50 text-sky-600" },
  { label: "Dispatched today", value: 11, icon: "✅", color: "bg-emerald-50 text-emerald-600" },
];
